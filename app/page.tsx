...
import { getNamesFromUrlPath, ParsedNames } from '@/lib/utils';
...
export default function LandingPage() {
  ...
  // Parse names from URL path and store in state for dynamic updates
  const [displayNames, setDisplayNames] = useState<ParsedNames>(() => getNamesFromUrlPath());
